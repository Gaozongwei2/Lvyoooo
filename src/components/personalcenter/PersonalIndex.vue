    ...
    <div class="nav  navbar navigation navbar-default title1 ">
      <div class="container">
        ...
        <ul class="nav navbar navbar-right usericno ">
          ...
          <li><a class="nopadding user" href="####" ><img class="img-circle icno col-md-6" :src="user.usericno" alt="" height="44px" width="44px"><span class="right  username nomargin">棕色试剂瓶</span></a></li>
        </ul>
    ...
    <div class="container-fluid title2">
      ...
      <div class="col-md-8 choose-top">
        <ul class = "nav navbar col-md-11 choose-top" >
          <li class = "col-md-3 nav navbar navbar-nav" @click="hide"><router-link to="/usercenter/mymessage"><a href="javascrip:;" @click.prevent.stop >我的信息</a></router-link></li>
    ...
    <div class="middle1 container-fluid">
      ...
      <div class="middle-left col-md-3">
        ...
        <ul class="rlist">
          ...
          <li @click="hide"><router-link to="/usercenter/mycollect"><div class="rbtn"><span>我的关注</span><span class="badge badgepart">12</span></div></router-link></li>
          <li @click="hide"><router-link to="/usercenter/myfocus"><div class="rbtn"><span>我的收藏</span><span class="badge badgepart">22</span></div></router-link></li>
          <li @click="hide"><router-link to="/usercenter"><div class="rbtn"><span>我的成就</span></div></router-link></li>
          <li @click="hide"><router-link to="/usercenter/mytravelnotes"><div class="rbtn"><span>我的游记</span><span class="badge badgepart">212</span></div></router-link></li>
          <li @click="hide"><router-link to="/usercenter/mystrategys"><div class="rbtn"><span>我的攻略</span><span class="badge badgepart">212</span></div></router-link></li>
      ...
      <div class="middle-right col-md-7 ">
        ...
        <div class="content">
          <div class="default" v-if="showcontent == 'index'">
            <img src="../../assets/images/imdex2.png" alt="">
          </div>
          <router-view/>
        </div>
      </div>
...
router-link:hover{
  ...
  .button2 {
    background-color: #8BC87A !important;
  ...
  .rbtn{
    ...
    height: 45px;
    padding:0 15px;
    background-color: rgba(0, 214, 0, 0.66);
  }
  .rbtn:hover{
